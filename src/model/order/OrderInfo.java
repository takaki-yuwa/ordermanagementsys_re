...
import java.util.List;
	...
	public class OrderInfo {
		...
		public OrderInfo(int order_id, String order_time, int product_quantity, int table_number, int order_flag, String product_name, String category_name, int product_price, int product_stock, List<OrderToppingInfo> order_topping) {
