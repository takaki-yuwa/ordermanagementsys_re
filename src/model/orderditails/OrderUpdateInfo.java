...
public class OrderUpdateInfo {
    ...
    // 必要な場合のコンストラクタ
    public OrderUpdateInfo(int order_id, int order_price, int product_quantity, int product_id, int product_stock, List<OrderUpdateToppingInfo> order_topping) {
    ...
    public int getOrderPrice() { return order_price; }
    public int getProductQuantity() { return product_quantity; }
    public int getProductId() { return product_id; }
    public int getProductStock() { return product_stock; }
    public List<OrderUpdateToppingInfo> getOrderTopping() { return order_topping; }

    // setter
    public void setOrderId(int order_id) { this.order_id = order_id; }
    public void setOrderPrice(int order_price) { this.order_id = order_price; }
    ...
    public void setOrderTopping(List<OrderUpdateToppingInfo> order_topping) { this.order_topping = order_topping; }
