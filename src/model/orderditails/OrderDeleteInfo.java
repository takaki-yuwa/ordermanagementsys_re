...
public class OrderDeleteInfo {
    ...
    // 必要な場合のコンストラクタ
    public OrderDeleteInfo(int order_id, int order_price, int product_id, int product_stock, List<OrderDeleteToppingInfo> order_topping) {
    ...
    public List<OrderDeleteToppingInfo> getOrderTopping() { return order_topping; }
    ...
    public void setOrderTopping(List<OrderDeleteToppingInfo> order_topping) { this.order_topping = order_topping; }
